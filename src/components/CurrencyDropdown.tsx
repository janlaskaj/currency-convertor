...
export const CurrencyDropdown: React.FC<{
    ...
    <Menu as="div" className="relative inline-block">
        ...
        >
            <Menu.Items className="absolute right-0 z-10 mt-2 h-60 w-24 origin-top-right divide-y divide-gray-100 overflow-scroll rounded-md bg-white shadow-2xl ring-1 ring-black ring-opacity-5 focus:outline-none">
